...
def gen_path_loader(path_vars: List[str], strip_prefix: str) -> str:
    ...
    Returns:
        str: Python as str to add runfiles to system PATH
    """
    ...
    with open("data/preamble_template.py", "r") as ifile:
